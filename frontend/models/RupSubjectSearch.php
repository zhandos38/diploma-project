...
class RupSubjectSearch extends RupSubject
{
    ...
    {
        return [
            [['id', 'rup_id', 'subject_id', 'lang', 'semester', 'amount_lecture', 'amount_practice', 'amount_lab', 'is_course_work', 'is_gos', 'is_exam', 'amount_extra', 'amount_srop'], 'integer'],
    ...
    public function search($params, $rup_id)
    {
        $query = RupSubject::find()
            ...
            ->leftJoin('module_item as t3' , 't3.id = t1.module_item_id')
            ->leftJoin('component_item as t4' , 't4.id = t1.component_item_id')
        ...
        $query->andFilterWhere([
            ...
            't1.amount_srop' => $this->amount_srop,
            't1.is_course_work' => $this->is_course_work,
            't1.is_gos' => $this->is_gos,
            't1.is_exam' => $this->is_exam,

            't1.module_item_id' => $this->module_item_id,
            't1.component_item_id' => $this->component_item_id,
